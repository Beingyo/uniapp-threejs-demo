...
export function fold(canvas, THREE) {
	...
	function init() {
		...
		STLloader.load('http://localhost:8080/host-manager/images/3DfootLeft_Last.stl', function(
			geometry) {
			// 建立几何中心
			geometry.center();
			// 几何体绕着某轴旋转度
		...
		OBJloader.load('http://localhost:8080/host-manager/images/shoes-10.obj', function(geometry) {
